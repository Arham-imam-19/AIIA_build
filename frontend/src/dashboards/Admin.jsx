...
export default function Admin(props) {
  ...
  // Extract audit logs specifically to render them manually with the requested filter
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            {auditBlock && (
              <div className="col-span-full rounded-none border border-slate-300 bg-white p-5 shadow-sm">
                <h3 className="mb-1 text-sm font-bold text-slate-800">{auditBlock.title}</h3>
